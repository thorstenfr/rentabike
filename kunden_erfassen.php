			...
			<div id="inhalt">
				<form action="kunden_erfasst.php" method="post">
					...
					<tr>
					  ...
					  <td><input name="kundennr" type="text" size="30" maxlength="30"></td>
					...
					<tr>
					  ...
					  <td><input name="wohnort" type="text" size="30" maxlength="40"></td>
					...
					<tr>
					  ...
					  <td><input name="geburtstag" type="text" size="30" maxlength="40"></td>
